    ...
    <>
      ...
      >
        ...
        <div className="bottom-scroll">
          {[...Array(5)].map((_, i) => (
            <span key={i} className="scroll-text">NBI CLEARANCE SYSTEM • PLEASE PREPARE YOUR REQUIREMENTS • FOR INQUIRIES, PLEASE CONTACT: ccd@nbi.gov.ph / +63 929 660 7861 • THANK YOU • </span>
          ))}
        </div>
      </div>
